...
@Mapper
@Component(value = "baseInfoMapper")
public interface BaseInfoMapper {
     ...
     * @return
     */
    @Select("select * from base_info limit #{page},#{pagesize}" )
    @Results({
            @Result(column="id", property="id", jdbcType=JdbcType.CHAR, id=true),
            @Result(column="germ_name", property="germName", jdbcType=JdbcType.VARCHAR),
            @Result(column="family_name", property="familyName", jdbcType=JdbcType.VARCHAR),
    ...
    List<BaseInfo> getAllBaseInfo(@Param("page") int page,@Param("pagesize")Integer pagesize );
